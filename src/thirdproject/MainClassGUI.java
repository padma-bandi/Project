package thirdproject; // This line declares the package "thirdproject" for the current Java file.
...
import javax.swing.*; // Importing necessary classes from the javax.swing package.




import java.awt.FlowLayout; // Importing the FlowLayout class from the java.awt package.


import java.awt.event.ActionEvent;

import java.awt.event.ActionListener; // Importing the ActionListener interface and ActionEvent class from the java.awt.event package.
...
public class MainClassGUI extends JFrame { // Declaration of the MainClassGUI, extending JFrame.


	private static final long serialVersionUID = 1L;     // A unique identifier to ensure compatibility during serialization.
 ...
 public MainClassGUI() {         // Constructor for the MainClassGUI.


 super("Online Shopping System");         // Setting the title of the JFrame.


 setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);         // Setting the default close operation.


 setSize(400, 300);         // Setting the size of the JFrame.
 ...
 createGUIComponents();         // Creating GUI components.
 ...
 private void createGUIComponents() {         // Method to create GUI components.


 JPanel panel = new JPanel(new FlowLayout());         // Creating a JPanel with FlowLayout.
 ...
 JButton registerButton = new JButton("Register");         // Creating a JButton for user registration.


 registerButton.setBounds(20, 20, 120, 30);         // Setting the bounds for the button.


 registerButton.addActionListener(new ActionListener() {             // Adding an ActionListener to handle button clicks.
